 ...
 * @author Yvonne Wang
 */
final class VFSJFileChooserApproveButtonTextQuery {

    static String approveButtonTextFrom(final VFSJFileChooser<?> fileChooser) {
    ...
    private VFSJFileChooserApproveButtonTextQuery() {
    }
}
